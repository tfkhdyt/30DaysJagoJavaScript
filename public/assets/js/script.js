...
const getVideosTitle = async (x, y) => {
  ...
  for (let i = x - 1; i < y; i++) {
    hasil.push(
      await fetch(
        `https://www.googleapis.com/youtube/v3/playlistItems?part=snippet&maxResults=50&playlistId=${playlistDasar}&key=${apiKey}`
      )
        .then((res) => res.json())
        .then((res) => res.items)
        .then((res) => res[i])
...
const getVideosTitle2 = async (x, y) => {
  ...
  for (let j = x - 1; j < y; j++) {
    hasil.push(
      await fetch(
        `https://www.googleapis.com/youtube/v3/playlistItems?part=snippet&maxResults=50&playlistId=${playlistDom}&key=${apiKey}`
      )
        .then((res) => res.json())
        .then((res) => res.items)
        .then((res) => res[j])
...
const getVideosTitle3 = async (x, y) => {
  ...
  for (let j = x - 1; j < y; j++) {
    hasil.push(
      await fetch(
        `https://www.googleapis.com/youtube/v3/playlistItems?part=snippet&maxResults=50&playlistId=${playlistLanjutan}&key=${apiKey}`
      )
        .then((res) => res.json())
        .then((res) => res.items)
        .then((res) => res[j])
...
const getVideosTitle4 = async (x, y) => {
  ...
  for (let j = x - 1; j < y; j++) {
    hasil.push(
      await fetch(
        `https://www.googleapis.com/youtube/v3/playlistItems?part=snippet&maxResults=50&playlistId=${playlistNode}&key=${apiKey}`
      )
        .then((res) => res.json())
        .then((res) => res.items)
        .then((res) => res[j])
